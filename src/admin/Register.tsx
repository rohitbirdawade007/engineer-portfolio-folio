...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative bg-background overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-foreground tracking-tight mb-2">Initialize Account</h1>
          <p className="text-muted-foreground font-medium">Create your administrative credentials.</p>
        </div>
          ...
          <CardContent className="p-8">
            <form onSubmit={handleRegister} className="space-y-6">
              <div className="space-y-2">
                <Label className="text-xs font-semibold text-muted-foreground">Setup Token</Label>
        ...
        <div className="mt-8 text-center">
           <Link to="/admin/login" className="inline-flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
